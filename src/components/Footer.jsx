...
function Footer() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed="-.01" className="w-full flex md:flex-nowrap flex-wrap md:gap-10 md:h-screen  bg-zinc-900  px-20">
        <div className="md:w-1/2   h-full w-full relative">
            <h1 className="text-[7vw] leading-none -ml-3  uppercase font-semibold tracking-tighter">Eye-</h1>
            <h1 className="text-[7vw] leading-none -ml-3  uppercase font-semibold tracking-tighter">Opening</h1>
            
           
           <div className="absolute -ml-20 pl-1 pb-1 -bottom-[70vh]  md:mb-5  md:-ml-20  md:left-10 md:bottom-10">
        ...
        <div className="md:w-1/2 pt-2 w-full">
        <h1 className="text-[5.9vw] tracking-tighter leading-none -ml-3  uppercase font-semibold -mt-1">Presentations</h1>
        <div className="w-full md:mt-20 mt-10 md:text-xl flex flex-wrap justify-between">
            <div className="md:w-1/2">
            <div className="flex flex-col">
               
            <Link className="hover:underline leading-2"to='#'>Instagram</Link>
            <Link className="hover:underline leading-2"to='#'>facebook</Link>
            <Link className="hover:underline leading-2"to='#'>LinkedIn</Link>
            <Link className="hover:underline leading-2"to='#'>Twitter</Link>
            <div className="my-2">
