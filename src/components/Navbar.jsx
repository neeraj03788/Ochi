...
function Navbar() {
  ...
  return (
    <div className=" fixed  z-[999] w-full flex justify-between md:px-20 pl-2 md:py-8 py-4 font-serif ">
        <div className="logo">
        ...
        <div className={`relative md:bg-transparent   ${(hover)?"bg-blue-600":""} `}>
        <div  className="lg:hidden bg-transparent  left-1/2 " onClick={()=>{sethover(!hover)}} >
          {(hover)?<span><RiCloseFill /></span>:<span><IoMenu /></span>}
        </div>
        <div className={`links relative md:flex md:gap-10 md:flex-row md:bg-transparent  bg-blue-600 w-[90vw] md:w-full ${(hover)?"":"hidden"}`}>
            <Link to="/" onClick={()=>{sethover(!hover)}}   className="text-md capitalize block font-light">Home</Link>
            <Link to="/about"  onClick={()=>{sethover(!hover)}}  className="text-md capitalize block font-light">About</Link>
            <Link to="/Service"  onClick={()=>{sethover(!hover)}}  className="text-md capitalize block font-light">Service</Link>
            <Link to="/contact"  onClick={()=>{sethover(!hover)}}  className="text-md capitalize block font-light">contact us</Link>
